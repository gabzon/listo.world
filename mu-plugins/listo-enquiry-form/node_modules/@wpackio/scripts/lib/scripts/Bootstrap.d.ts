...
declare class InitResolve {
    ...
    constructor(configured: 'project' | 'server', serverConfigContext?: ServerConfigContext, projectConfigContext?: ProjectConfigContext, deps?: ProjectDependencies);
}
export declare class Bootstrap {
    ...
    getUserInput(): Promise<inquirer.Answers>;
    /**
